...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('template/service/style.css') }}">
...
<body>
    <header>
      ...
      <div class="container-fluid first py-3">
        <h1 class="text-light p-4 py-5 mb-5 eficoN" >Our Services</h1>
      </div>
            ...
            <div class="content mx-auto">
              <div class="row">
                ...
                <div class="segment mx-auto">
                  <img src="{{ asset('template/assets/img/Ellipse.png') }}" style="width: 10%; margin-top: 3%;">
                <h1>Career Talks</h1>
