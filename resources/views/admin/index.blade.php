        ...
        <div class="page-content--bgf7" id="app">
            ...
            <section class="p-t-20">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <button class="au-btn au-btn-icon au-btn--green au-btn--small" style="float: right;" type="button" data-toggle="modal" data-target="#mediumModal"><i class="zmdi zmdi-plus"></i>add user</button>
            ...
            <section class="p-t-20 mt-5">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="/admin/create" class="au-btn au-btn-icon au-btn--green au-btn--small" style="float: right;"><i class="zmdi zmdi-plus"></i>add post</a>
